...
const Login = () => {
    ...
    try {
        ...
        if (userFound) {
            // marca de sesión simple; sustitúyelo por JWT/Firebase Auth si luego migras
            localStorage.setItem("token", userFound.id || "logged");
                                ...
                                <div className="card-body p-4">
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <div className="mb-3">
                                            ...
                                            <input type="email" className="form-control" id="email" name="email" placeholder="ejemplo@gmail.com" value={formData.email} onChange={handleChange} required
                                                style={{ borderRadius: "8px", border: "1px solid #ddd", padding: "0.75rem" }}/>
                                        </div>
                                        <div className="mb-3">
                                            ...
                                            <div className="position-relative">
                                                ...
                                                <button type="button" className="btn position-absolute end-0 top-50 translate-middle-y me-2" style={{ border: "none", background: "none", color: "#6c757d", zIndex: 10 }} onClick={togglePassword} aria-label={showPassword ? "Ocultar contraseña" : "Mostrar contraseña"}>
                                                    <i className={showPassword ? "fas fa-eye-slash" : "fas fa-eye"}></i>
                                                </button>
                                            </div>
                                        </div>
                                        <button type="submit" className="btn btn-danger w-100 fw-medium" disabled={submitting} style={{ borderRadius: "8px", padding: "0.75rem" }}>
